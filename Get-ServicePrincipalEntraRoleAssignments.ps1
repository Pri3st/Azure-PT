# Script to get all Role Assignments for a Service Principal, both Direct and Indirect (via Group membership).
...
$user = Get-MgServicePrincipal | Where-Object {$_.DisplayName -like "*<SERVICE_PRINCIPAL_NAME*"}
$userId = $user.Id
